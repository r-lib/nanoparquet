...
template<typename T> struct SparseTensorIndexUnionTraits {
  static const SparseTensorIndex enum_value = SparseTensorIndex_NONE;
};

template<> struct SparseTensorIndexUnionTraits<org::apache::arrow::flatbuf::SparseTensorIndexCOOT> {
  static const SparseTensorIndex enum_value = SparseTensorIndex_SparseTensorIndexCOO;
};

template<> struct SparseTensorIndexUnionTraits<org::apache::arrow::flatbuf::SparseMatrixIndexCSXT> {
  static const SparseTensorIndex enum_value = SparseTensorIndex_SparseMatrixIndexCSX;
};

template<> struct SparseTensorIndexUnionTraits<org::apache::arrow::flatbuf::SparseTensorIndexCSFT> {
  static const SparseTensorIndex enum_value = SparseTensorIndex_SparseTensorIndexCSF;
};

struct SparseTensorIndexUnion {
  SparseTensorIndex type;
  void *value;

  SparseTensorIndexUnion() : type(SparseTensorIndex_NONE), value(nullptr) {}
  SparseTensorIndexUnion(SparseTensorIndexUnion&& u) FLATBUFFERS_NOEXCEPT :
    type(SparseTensorIndex_NONE), value(nullptr)
    { std::swap(type, u.type); std::swap(value, u.value); }
  SparseTensorIndexUnion(const SparseTensorIndexUnion &);
  SparseTensorIndexUnion &operator=(const SparseTensorIndexUnion &u)
    { SparseTensorIndexUnion t(u); std::swap(type, t.type); std::swap(value, t.value); return *this; }
  SparseTensorIndexUnion &operator=(SparseTensorIndexUnion &&u) FLATBUFFERS_NOEXCEPT
    { std::swap(type, u.type); std::swap(value, u.value); return *this; }
  ~SparseTensorIndexUnion() { Reset(); }
  ...
  void Set(T&& val) {
    ...
    Reset();
    type = SparseTensorIndexUnionTraits<RT>::enum_value;
    if (type != SparseTensorIndex_NONE) {
      value = new RT(std::forward<T>(val));
    }
  }

  static void *UnPack(const void *obj, SparseTensorIndex type, const ::flatbuffers::resolver_function_t *resolver);
  ::flatbuffers::Offset<void> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr) const;

  org::apache::arrow::flatbuf::SparseTensorIndexCOOT *AsSparseTensorIndexCOO() {
    return type == SparseTensorIndex_SparseTensorIndexCOO ?
      reinterpret_cast<org::apache::arrow::flatbuf::SparseTensorIndexCOOT *>(value) : nullptr;
  }
  const org::apache::arrow::flatbuf::SparseTensorIndexCOOT *AsSparseTensorIndexCOO() const {
    return type == SparseTensorIndex_SparseTensorIndexCOO ?
      reinterpret_cast<const org::apache::arrow::flatbuf::SparseTensorIndexCOOT *>(value) : nullptr;
  }
  org::apache::arrow::flatbuf::SparseMatrixIndexCSXT *AsSparseMatrixIndexCSX() {
    return type == SparseTensorIndex_SparseMatrixIndexCSX ?
      reinterpret_cast<org::apache::arrow::flatbuf::SparseMatrixIndexCSXT *>(value) : nullptr;
  }
  const org::apache::arrow::flatbuf::SparseMatrixIndexCSXT *AsSparseMatrixIndexCSX() const {
    return type == SparseTensorIndex_SparseMatrixIndexCSX ?
      reinterpret_cast<const org::apache::arrow::flatbuf::SparseMatrixIndexCSXT *>(value) : nullptr;
  }
  org::apache::arrow::flatbuf::SparseTensorIndexCSFT *AsSparseTensorIndexCSF() {
    return type == SparseTensorIndex_SparseTensorIndexCSF ?
      reinterpret_cast<org::apache::arrow::flatbuf::SparseTensorIndexCSFT *>(value) : nullptr;
  }
  const org::apache::arrow::flatbuf::SparseTensorIndexCSFT *AsSparseTensorIndexCSF() const {
    return type == SparseTensorIndex_SparseTensorIndexCSF ?
      reinterpret_cast<const org::apache::arrow::flatbuf::SparseTensorIndexCSFT *>(value) : nullptr;
  }
};
...
struct SparseTensorIndexCOOT : public ::flatbuffers::NativeTable {
  typedef SparseTensorIndexCOO TableType;
  std::unique_ptr<org::apache::arrow::flatbuf::IntT> indicesType{};
  std::vector<int64_t> indicesStrides{};
  std::unique_ptr<org::apache::arrow::flatbuf::Buffer> indicesBuffer{};
  bool isCanonical = false;
  SparseTensorIndexCOOT() = default;
  SparseTensorIndexCOOT(const SparseTensorIndexCOOT &o);
  SparseTensorIndexCOOT(SparseTensorIndexCOOT&&) FLATBUFFERS_NOEXCEPT = default;
  SparseTensorIndexCOOT &operator=(SparseTensorIndexCOOT o) FLATBUFFERS_NOEXCEPT;
};
...
struct SparseTensorIndexCOO FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SparseTensorIndexCOOT NativeTableType;
  ...
  SparseTensorIndexCOOT *UnPack(const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(SparseTensorIndexCOOT *_o, const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static ::flatbuffers::Offset<SparseTensorIndexCOO> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorIndexCOOT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
::flatbuffers::Offset<SparseTensorIndexCOO> CreateSparseTensorIndexCOO(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorIndexCOOT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);

struct SparseMatrixIndexCSXT : public ::flatbuffers::NativeTable {
  typedef SparseMatrixIndexCSX TableType;
  ...
  std::unique_ptr<org::apache::arrow::flatbuf::IntT> indptrType{};
  std::unique_ptr<org::apache::arrow::flatbuf::Buffer> indptrBuffer{};
  std::unique_ptr<org::apache::arrow::flatbuf::IntT> indicesType{};
  std::unique_ptr<org::apache::arrow::flatbuf::Buffer> indicesBuffer{};
  SparseMatrixIndexCSXT() = default;
  SparseMatrixIndexCSXT(const SparseMatrixIndexCSXT &o);
  SparseMatrixIndexCSXT(SparseMatrixIndexCSXT&&) FLATBUFFERS_NOEXCEPT = default;
  SparseMatrixIndexCSXT &operator=(SparseMatrixIndexCSXT o) FLATBUFFERS_NOEXCEPT;
};

/// Compressed Sparse format, that is matrix-specific.
struct SparseMatrixIndexCSX FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SparseMatrixIndexCSXT NativeTableType;
  ...
  SparseMatrixIndexCSXT *UnPack(const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(SparseMatrixIndexCSXT *_o, const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static ::flatbuffers::Offset<SparseMatrixIndexCSX> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SparseMatrixIndexCSXT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
::flatbuffers::Offset<SparseMatrixIndexCSX> CreateSparseMatrixIndexCSX(::flatbuffers::FlatBufferBuilder &_fbb, const SparseMatrixIndexCSXT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);

struct SparseTensorIndexCSFT : public ::flatbuffers::NativeTable {
  typedef SparseTensorIndexCSF TableType;
  std::unique_ptr<org::apache::arrow::flatbuf::IntT> indptrType{};
  std::vector<org::apache::arrow::flatbuf::Buffer> indptrBuffers{};
  std::unique_ptr<org::apache::arrow::flatbuf::IntT> indicesType{};
  std::vector<org::apache::arrow::flatbuf::Buffer> indicesBuffers{};
  std::vector<int32_t> axisOrder{};
  SparseTensorIndexCSFT() = default;
  SparseTensorIndexCSFT(const SparseTensorIndexCSFT &o);
  SparseTensorIndexCSFT(SparseTensorIndexCSFT&&) FLATBUFFERS_NOEXCEPT = default;
  SparseTensorIndexCSFT &operator=(SparseTensorIndexCSFT o) FLATBUFFERS_NOEXCEPT;
};

/// Compressed Sparse Fiber (CSF) sparse tensor index.
struct SparseTensorIndexCSF FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SparseTensorIndexCSFT NativeTableType;
  ...
  SparseTensorIndexCSFT *UnPack(const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(SparseTensorIndexCSFT *_o, const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static ::flatbuffers::Offset<SparseTensorIndexCSF> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorIndexCSFT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
::flatbuffers::Offset<SparseTensorIndexCSF> CreateSparseTensorIndexCSF(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorIndexCSFT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);

struct SparseTensorT : public ::flatbuffers::NativeTable {
  ...
  org::apache::arrow::flatbuf::SparseTensorIndexUnion sparseIndex{};
  std::unique_ptr<org::apache::arrow::flatbuf::Buffer> data{};
  SparseTensorT() = default;
  SparseTensorT(const SparseTensorT &o);
  SparseTensorT(SparseTensorT&&) FLATBUFFERS_NOEXCEPT = default;
  SparseTensorT &operator=(SparseTensorT o) FLATBUFFERS_NOEXCEPT;
};

struct SparseTensor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SparseTensorT NativeTableType;
  ...
  SparseTensorT *UnPack(const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(SparseTensorT *_o, const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static ::flatbuffers::Offset<SparseTensor> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
::flatbuffers::Offset<SparseTensor> CreateSparseTensor(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);

inline SparseTensorIndexCOOT::SparseTensorIndexCOOT(const SparseTensorIndexCOOT &o)
      : indicesType((o.indicesType) ? new org::apache::arrow::flatbuf::IntT(*o.indicesType) : nullptr),
        indicesStrides(o.indicesStrides),
        indicesBuffer((o.indicesBuffer) ? new org::apache::arrow::flatbuf::Buffer(*o.indicesBuffer) : nullptr),
        isCanonical(o.isCanonical) {
}

inline SparseTensorIndexCOOT &SparseTensorIndexCOOT::operator=(SparseTensorIndexCOOT o) FLATBUFFERS_NOEXCEPT {
  std::swap(indicesType, o.indicesType);
  std::swap(indicesStrides, o.indicesStrides);
  std::swap(indicesBuffer, o.indicesBuffer);
  std::swap(isCanonical, o.isCanonical);
  return *this;
}

inline SparseTensorIndexCOOT *SparseTensorIndexCOO::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SparseTensorIndexCOOT>(new SparseTensorIndexCOOT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void SparseTensorIndexCOO::UnPackTo(SparseTensorIndexCOOT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = indicesType(); if (_e) { if(_o->indicesType) { _e->UnPackTo(_o->indicesType.get(), _resolver); } else { _o->indicesType = std::unique_ptr<org::apache::arrow::flatbuf::IntT>(_e->UnPack(_resolver)); } } else if (_o->indicesType) { _o->indicesType.reset(); } }
  { auto _e = indicesStrides(); if (_e) { _o->indicesStrides.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->indicesStrides[_i] = _e->Get(_i); } } else { _o->indicesStrides.resize(0); } }
  { auto _e = indicesBuffer(); if (_e) _o->indicesBuffer = std::unique_ptr<org::apache::arrow::flatbuf::Buffer>(new org::apache::arrow::flatbuf::Buffer(*_e)); }
  { auto _e = isCanonical(); _o->isCanonical = _e; }
}

inline ::flatbuffers::Offset<SparseTensorIndexCOO> SparseTensorIndexCOO::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorIndexCOOT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSparseTensorIndexCOO(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<SparseTensorIndexCOO> CreateSparseTensorIndexCOO(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorIndexCOOT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const SparseTensorIndexCOOT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _indicesType = _o->indicesType ? CreateInt(_fbb, _o->indicesType.get(), _rehasher) : 0;
  auto _indicesStrides = _o->indicesStrides.size() ? _fbb.CreateVector(_o->indicesStrides) : 0;
  auto _indicesBuffer = _o->indicesBuffer ? _o->indicesBuffer.get() : nullptr;
  auto _isCanonical = _o->isCanonical;
  return org::apache::arrow::flatbuf::CreateSparseTensorIndexCOO(
      _fbb,
      _indicesType,
      _indicesStrides,
...
inline SparseMatrixIndexCSXT::SparseMatrixIndexCSXT(const SparseMatrixIndexCSXT &o)
      : compressedAxis(o.compressedAxis),
        indptrType((o.indptrType) ? new org::apache::arrow::flatbuf::IntT(*o.indptrType) : nullptr),
        indptrBuffer((o.indptrBuffer) ? new org::apache::arrow::flatbuf::Buffer(*o.indptrBuffer) : nullptr),
        indicesType((o.indicesType) ? new org::apache::arrow::flatbuf::IntT(*o.indicesType) : nullptr),
        indicesBuffer((o.indicesBuffer) ? new org::apache::arrow::flatbuf::Buffer(*o.indicesBuffer) : nullptr) {
}

inline SparseMatrixIndexCSXT &SparseMatrixIndexCSXT::operator=(SparseMatrixIndexCSXT o) FLATBUFFERS_NOEXCEPT {
  std::swap(compressedAxis, o.compressedAxis);
  std::swap(indptrType, o.indptrType);
  std::swap(indptrBuffer, o.indptrBuffer);
  std::swap(indicesType, o.indicesType);
  std::swap(indicesBuffer, o.indicesBuffer);
  return *this;
}

inline SparseMatrixIndexCSXT *SparseMatrixIndexCSX::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SparseMatrixIndexCSXT>(new SparseMatrixIndexCSXT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void SparseMatrixIndexCSX::UnPackTo(SparseMatrixIndexCSXT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = compressedAxis(); _o->compressedAxis = _e; }
  { auto _e = indptrType(); if (_e) { if(_o->indptrType) { _e->UnPackTo(_o->indptrType.get(), _resolver); } else { _o->indptrType = std::unique_ptr<org::apache::arrow::flatbuf::IntT>(_e->UnPack(_resolver)); } } else if (_o->indptrType) { _o->indptrType.reset(); } }
  { auto _e = indptrBuffer(); if (_e) _o->indptrBuffer = std::unique_ptr<org::apache::arrow::flatbuf::Buffer>(new org::apache::arrow::flatbuf::Buffer(*_e)); }
  { auto _e = indicesType(); if (_e) { if(_o->indicesType) { _e->UnPackTo(_o->indicesType.get(), _resolver); } else { _o->indicesType = std::unique_ptr<org::apache::arrow::flatbuf::IntT>(_e->UnPack(_resolver)); } } else if (_o->indicesType) { _o->indicesType.reset(); } }
  { auto _e = indicesBuffer(); if (_e) _o->indicesBuffer = std::unique_ptr<org::apache::arrow::flatbuf::Buffer>(new org::apache::arrow::flatbuf::Buffer(*_e)); }
}

inline ::flatbuffers::Offset<SparseMatrixIndexCSX> SparseMatrixIndexCSX::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SparseMatrixIndexCSXT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSparseMatrixIndexCSX(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<SparseMatrixIndexCSX> CreateSparseMatrixIndexCSX(::flatbuffers::FlatBufferBuilder &_fbb, const SparseMatrixIndexCSXT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const SparseMatrixIndexCSXT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _compressedAxis = _o->compressedAxis;
  auto _indptrType = _o->indptrType ? CreateInt(_fbb, _o->indptrType.get(), _rehasher) : 0;
  auto _indptrBuffer = _o->indptrBuffer ? _o->indptrBuffer.get() : nullptr;
  auto _indicesType = _o->indicesType ? CreateInt(_fbb, _o->indicesType.get(), _rehasher) : 0;
  auto _indicesBuffer = _o->indicesBuffer ? _o->indicesBuffer.get() : nullptr;
  return org::apache::arrow::flatbuf::CreateSparseMatrixIndexCSX(
      _fbb,
      _compressedAxis,
      _indptrType,
      _indptrBuffer,
...
inline SparseTensorIndexCSFT::SparseTensorIndexCSFT(const SparseTensorIndexCSFT &o)
      : indptrType((o.indptrType) ? new org::apache::arrow::flatbuf::IntT(*o.indptrType) : nullptr),
        indptrBuffers(o.indptrBuffers),
        indicesType((o.indicesType) ? new org::apache::arrow::flatbuf::IntT(*o.indicesType) : nullptr),
        indicesBuffers(o.indicesBuffers),
        axisOrder(o.axisOrder) {
}

inline SparseTensorIndexCSFT &SparseTensorIndexCSFT::operator=(SparseTensorIndexCSFT o) FLATBUFFERS_NOEXCEPT {
  std::swap(indptrType, o.indptrType);
  std::swap(indptrBuffers, o.indptrBuffers);
  std::swap(indicesType, o.indicesType);
  std::swap(indicesBuffers, o.indicesBuffers);
  std::swap(axisOrder, o.axisOrder);
  return *this;
}

inline SparseTensorIndexCSFT *SparseTensorIndexCSF::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SparseTensorIndexCSFT>(new SparseTensorIndexCSFT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void SparseTensorIndexCSF::UnPackTo(SparseTensorIndexCSFT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = indptrType(); if (_e) { if(_o->indptrType) { _e->UnPackTo(_o->indptrType.get(), _resolver); } else { _o->indptrType = std::unique_ptr<org::apache::arrow::flatbuf::IntT>(_e->UnPack(_resolver)); } } else if (_o->indptrType) { _o->indptrType.reset(); } }
  { auto _e = indptrBuffers(); if (_e) { _o->indptrBuffers.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->indptrBuffers[_i] = *_e->Get(_i); } } else { _o->indptrBuffers.resize(0); } }
  { auto _e = indicesType(); if (_e) { if(_o->indicesType) { _e->UnPackTo(_o->indicesType.get(), _resolver); } else { _o->indicesType = std::unique_ptr<org::apache::arrow::flatbuf::IntT>(_e->UnPack(_resolver)); } } else if (_o->indicesType) { _o->indicesType.reset(); } }
  { auto _e = indicesBuffers(); if (_e) { _o->indicesBuffers.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->indicesBuffers[_i] = *_e->Get(_i); } } else { _o->indicesBuffers.resize(0); } }
  { auto _e = axisOrder(); if (_e) { _o->axisOrder.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->axisOrder[_i] = _e->Get(_i); } } else { _o->axisOrder.resize(0); } }
}

inline ::flatbuffers::Offset<SparseTensorIndexCSF> SparseTensorIndexCSF::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorIndexCSFT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSparseTensorIndexCSF(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<SparseTensorIndexCSF> CreateSparseTensorIndexCSF(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorIndexCSFT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const SparseTensorIndexCSFT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _indptrType = _o->indptrType ? CreateInt(_fbb, _o->indptrType.get(), _rehasher) : 0;
  auto _indptrBuffers = _fbb.CreateVectorOfStructs(_o->indptrBuffers);
  auto _indicesType = _o->indicesType ? CreateInt(_fbb, _o->indicesType.get(), _rehasher) : 0;
  auto _indicesBuffers = _fbb.CreateVectorOfStructs(_o->indicesBuffers);
  auto _axisOrder = _fbb.CreateVector(_o->axisOrder);
  return org::apache::arrow::flatbuf::CreateSparseTensorIndexCSF(
      _fbb,
      _indptrType,
      _indptrBuffers,
...
inline SparseTensorT::SparseTensorT(const SparseTensorT &o)
      : type(o.type),
        non_zero_length(o.non_zero_length),
        sparseIndex(o.sparseIndex),
...
inline SparseTensorT &SparseTensorT::operator=(SparseTensorT o) FLATBUFFERS_NOEXCEPT {
  std::swap(type, o.type);
  std::swap(shape, o.shape);
  std::swap(non_zero_length, o.non_zero_length);
  std::swap(sparseIndex, o.sparseIndex);
  std::swap(data, o.data);
  return *this;
}

inline SparseTensorT *SparseTensor::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SparseTensorT>(new SparseTensorT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void SparseTensor::UnPackTo(SparseTensorT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  ...
  { auto _e = non_zero_length(); _o->non_zero_length = _e; }
  { auto _e = sparseIndex_type(); _o->sparseIndex.type = _e; }
  { auto _e = sparseIndex(); if (_e) _o->sparseIndex.value = org::apache::arrow::flatbuf::SparseTensorIndexUnion::UnPack(_e, sparseIndex_type(), _resolver); }
  { auto _e = data(); if (_e) _o->data = std::unique_ptr<org::apache::arrow::flatbuf::Buffer>(new org::apache::arrow::flatbuf::Buffer(*_e)); }
}

inline ::flatbuffers::Offset<SparseTensor> SparseTensor::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSparseTensor(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<SparseTensor> CreateSparseTensor(::flatbuffers::FlatBufferBuilder &_fbb, const SparseTensorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const SparseTensorT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  ...
  auto _non_zero_length = _o->non_zero_length;
  auto _sparseIndex_type = _o->sparseIndex.type;
  auto _sparseIndex = _o->sparseIndex.Pack(_fbb);
...
inline void *SparseTensorIndexUnion::UnPack(const void *obj, SparseTensorIndex type, const ::flatbuffers::resolver_function_t *resolver) {
  (void)resolver;
  switch (type) {
    case SparseTensorIndex_SparseTensorIndexCOO: {
      auto ptr = reinterpret_cast<const org::apache::arrow::flatbuf::SparseTensorIndexCOO *>(obj);
...
inline ::flatbuffers::Offset<void> SparseTensorIndexUnion::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ::flatbuffers::rehasher_function_t *_rehasher) const {
  (void)_rehasher;
  switch (type) {
    case SparseTensorIndex_SparseTensorIndexCOO: {
      auto ptr = reinterpret_cast<const org::apache::arrow::flatbuf::SparseTensorIndexCOOT *>(value);
      return CreateSparseTensorIndexCOO(_fbb, ptr, _rehasher).Union();
    }
    case SparseTensorIndex_SparseMatrixIndexCSX: {
      auto ptr = reinterpret_cast<const org::apache::arrow::flatbuf::SparseMatrixIndexCSXT *>(value);
      return CreateSparseMatrixIndexCSX(_fbb, ptr, _rehasher).Union();
    }
    case SparseTensorIndex_SparseTensorIndexCSF: {
      auto ptr = reinterpret_cast<const org::apache::arrow::flatbuf::SparseTensorIndexCSFT *>(value);
      return CreateSparseTensorIndexCSF(_fbb, ptr, _rehasher).Union();
    }
    default: return 0;
  }
}

inline SparseTensorIndexUnion::SparseTensorIndexUnion(const SparseTensorIndexUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case SparseTensorIndex_SparseTensorIndexCOO: {
      value = new org::apache::arrow::flatbuf::SparseTensorIndexCOOT(*reinterpret_cast<org::apache::arrow::flatbuf::SparseTensorIndexCOOT *>(u.value));
      break;
    }
    case SparseTensorIndex_SparseMatrixIndexCSX: {
      value = new org::apache::arrow::flatbuf::SparseMatrixIndexCSXT(*reinterpret_cast<org::apache::arrow::flatbuf::SparseMatrixIndexCSXT *>(u.value));
      break;
    }
    case SparseTensorIndex_SparseTensorIndexCSF: {
      value = new org::apache::arrow::flatbuf::SparseTensorIndexCSFT(*reinterpret_cast<org::apache::arrow::flatbuf::SparseTensorIndexCSFT *>(u.value));
      break;
    }
    default:
      break;
...
inline void SparseTensorIndexUnion::Reset() {
  switch (type) {
    case SparseTensorIndex_SparseTensorIndexCOO: {
      auto ptr = reinterpret_cast<org::apache::arrow::flatbuf::SparseTensorIndexCOOT *>(value);
      delete ptr;
      break;
    }
    case SparseTensorIndex_SparseMatrixIndexCSX: {
      auto ptr = reinterpret_cast<org::apache::arrow::flatbuf::SparseMatrixIndexCSXT *>(value);
      delete ptr;
      break;
    }
    case SparseTensorIndex_SparseTensorIndexCSF: {
      auto ptr = reinterpret_cast<org::apache::arrow::flatbuf::SparseTensorIndexCSFT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline std::unique_ptr<org::apache::arrow::flatbuf::SparseTensorT> UnPackSparseTensor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<org::apache::arrow::flatbuf::SparseTensorT>(GetSparseTensor(buf)->UnPack(res));
}

inline std::unique_ptr<org::apache::arrow::flatbuf::SparseTensorT> UnPackSizePrefixedSparseTensor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<org::apache::arrow::flatbuf::SparseTensorT>(GetSizePrefixedSparseTensor(buf)->UnPack(res));
}

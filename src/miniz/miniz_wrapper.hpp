...
public:
	...
	static void InitializeGZIPFooter(unsigned char *gzip_footer, miniz::mz_ulong crc, size_t uncompressed_size) {
	...
	void Compress(const char *uncompressed_data, size_t uncompressed_size, char *out_data, size_t *out_size) {
		...
		auto crc = miniz::mz_crc32(MZ_CRC32_INIT, (const unsigned char*) uncompressed_data, uncompressed_size);

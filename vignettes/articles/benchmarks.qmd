...
* The data.table CSV writer is about 6 times as fast as the nanoparquet
  ...
  least 7 threads, the Parquet write is single-threaded.
* The nanoparquet Parquet writer is about 2 times faster than the data.table
...
* nanoparquet is again very competitive in terms of speed, for these data
  sets.
